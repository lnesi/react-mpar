...
**d. Data Attribute State:** `data-state="e30="` Following the same principles of data-props this attribute will contain a base64 encoded JSON object (contract), the only difference is the role that this data plays into the integration. For React-MPAR the centralize state method of choice is [Redux](https://redux.js.org/basics/usage-with-react) and [Flux](https://facebook.github.io/flux/) principles.

**Important**: This is an opensource project so feel free to fork this if you desire to change the centralize state principles to another library like [MobX](https://mobx.js.org/getting-started.html) or [React hooks](https://reactjs.org/docs/hooks-state.html) and/or [React context](https://reactjs.org/docs/context.html).
